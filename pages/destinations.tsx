...
export default function Destinations({ destinations }: Props) {
  return (
    <>
      <HeadComponent
        title="VW Wisata Borobudur - Destination"
        description="Temukan Destination terbaik di sekitar Borobudur dengan pemandangan indah dan menyenangkan. Liburan seru dan tak terlupakan sudah menunggu!"
      />
