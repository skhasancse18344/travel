            ...
            <div className="grid gap-10 lg:grid-cols-2">
              <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
                <div className="max-w-xl mb-2">
                  ...
                  Explore nature and culture in Borobudur with VW Safari
                  </h2>
                  <p className="mt-3 mb-10 text-white md:text-lg">
                  Time for <i>healing</i>   by traveling to enjoy the natural scenery, culture and art in Borobudur with VW Safari
                  </p>
                </div>
