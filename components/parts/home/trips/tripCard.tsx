      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {isSelectedTrip ? "Selected" : "CHOOSE THIS TRIP"}
            </button>
          </div>
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    Trip Package Selected Successfully
                  </Dialog.Title>
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      {trip.category == TripCategory.Sunrise1
                        ? `Next, please choose${trip.totalDestination} Other destinations besides Punthuk Setumbu.`
                        : trip.category == TripCategory.Sunrise2
                        ? `Next, please choose ${trip.totalDestination} Other destinations besides the Six Heavens.`
                        : `Next, please choose maximum ${trip.totalDestination} Destination.`}
                    </p>
                  </div>
