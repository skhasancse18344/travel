...
export default function Cart({ isShow, onDismiss }: CartInterface) {
  ...
  const waMessage = `Halo%20admin,%0ASaya%20mau%20booking%20trip%20dengan%20detail:%0A%0APackage%20Wisata:%20${
    trip.title
  }%0AAmount%20Orang:%20${people}%0AAmount%20Unit:%20${car}%0ADestination:%20${selectedDestinations}%0AAdditional:%20${selectedAdditionals}%0AEstimasi%20Total:%20Rp%20${currencyFormatter(
    total
  )}`;
  ...
  return (
    <>
      ...
      <Alert isShowed={isAlertShow} setIsShowed={setIsAlertShow}>
        <p>
        Please fill in the <u>Number of People</u> column first
        </p>
      </Alert>
    </>
  );
