...
export const destinationsData: DestinationInterface[] = [
  ...
  },
  {
    ...
    description:
      "Destination wisata yang menawarkan pemandangan matahari terbit dengan latar belakang gunung Merapi dan Merbabu, dipercantik view Candi Borobudur, adapun beberapa spot foto yang disediakan.",
  ...
  },
  {
    ...
    description:
      "Junkyard Autopark & Coffee sebuah Destination wisata baru bertema otomotif dengan menyajikan mobil-mobil bekas yang cocok buat jadi spot foto kekinian. Di tempat ini ada puluhan mobil klasik yang bisa kamu jadikan latar foto kamu.",
  ...
  },
  {
    ...
    title: "Svarga Earth",
    description:
      "Svargabumi is an alternative tourist spot located around Borobudur temple. Svargabumi offers views of farmers' rice fields decorated with interesting photo spots for visitors. Apart from that, the view of the Borobudur temple which looks majestic on the east side adds to the charm of this place.",
